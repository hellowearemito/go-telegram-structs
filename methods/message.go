...
type SendMessage struct {
	...
	ReplyMarkup *types.ReplyMarkup `json:"reply_markup"` // InlineKeyboardMarkup or ReplyKeyboardMarkup or ReplyKeyboardRemove or ForceReply. Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user.
}
...
type SendPhoto struct {
	ChatID string `json:"chat_id"` // String or Integer. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Photo types.InputFile `json:"photo"` // InputFile or String. Photo to send. Pass a file_id as String to send a photo that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a photo from the Internet, or upload a new photo using multipart/form-data.
...
type SendAudio struct {
	ChatID string `json:"chat_id"` // String or Integer. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Audio types.InputFile `json:"audio"` // Audio file to send. Pass a file_id as String to send an audio file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an audio file from the Internet, or upload a new one using multipart/form-data.
...
type SendDocument struct {
	ChatID string `json:"chat_id"` // String or Integer. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Document types.InputFile `json:"document"` // File to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data.
...
type SendVideo struct {
	ChatID   string          `json:"chat_id"`  // String or Integer. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Video    types.InputFile `json:"video"`    // InputFile or String. Video to send. Pass a file_id as String to send a video that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the Internet, or upload a new video using multipart/form-data.
...
type SendVoice struct {
	...
	Voice types.InputFile `json:"voice"` // Audio file to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data.
...
type SendVideoNote struct {
	...
	VideoNote types.InputFile `json:"video_note"` // InputFile or String. Video note to send. Pass a file_id as String to send a video note that exists on the Telegram servers (recommended) or upload a new video using multipart/form-data. More info on Sending Files ». Sending video notes by a URL is currently unsupported
	Duration *int64 `json:"duration"` // Duration of sent video in seconds
...
type SendMediaGroup struct {
	ChatID string `json:"chat_id"` // String or Integer. Unique identifier for the target chat or username of the target channel (in the format @channelusername)
	Media []types.InputMedia `json:"media"` // A JSON-serialized array describing photos and videos to be sent, must include 2–10 items
...
type SendLocation struct {
	...
	DisableNotification *bool `json:"disable_notification"` // Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID *int64 `json:"reply_to_message_id"` // If the message is a reply, ID of the original message
	ReplyMarkup *types.ReplyMarkup `json:"reply_markup"` // Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove reply keyboard or to force a reply from the user.
}
...
type EditMessageLiveLocation struct {
	...
	ReplyMarkup *types.InlineKeyboardMarkup `json:"reply_markup"` // A JSON-serialized object for a new inline keyboard.
}
...
type SendContact struct {
	...
	DisableNotification *bool `json:"disable_notification"` // Sends the message silently. Users will receive a notification with no sound.
	ReplyToMessageID *int64 `json:"reply_to_message_id"` // If the message is a reply, ID of the original message
	ReplyMarkup *types.ReplyMarkup `json:"reply_markup"` // Additional interface options. A JSON-serialized object for an inline keyboard, custom reply keyboard, instructions to remove keyboard or to force a reply from the user.
}
